...
<style>
    h2 {
        color: #7ab50b !important;
    }

    h2::after {
        top: 114%;
        width: 65%;
        background-color: #7ab50b !important;
        display: none;
    }
...
@section('content')
    <div class="wrap">
        <div class="content" style="margin-top: 50px; margin-left: 90px">
            <h2 class="titulo"><strong>Crocs</strong></h2>
        </div>
                ...
                <div class="row centro" style="margin-bottom: 10px;">
                    ...
                    <div class="col-md-4">
                        <div class="row">
                            ...
                            <div class="col-10">
                                <span style="font-size: 24;">Parceria desde 2006</span>
                            </div>
                        </div>
                        <br />
                        <div class="row">
                            ...
                            <div class="col-10">
                                <span style="font-size: 24;">Presente nos Estados: MA, PI e CE</span>
                            </div>
                        </div>
                        <br />
                        <div class="row">
                            ...
                            <div class="col-10">
                                <span style="font-size: 24;">Atuando com 4 PDVS</span>
                            </div>
                        </div>
                        <br />
                        <div class="row">
