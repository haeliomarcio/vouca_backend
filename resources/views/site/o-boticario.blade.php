                ...
                <div class="row centro" style="margin-bottom: 10px;">
                    ...
                    <div class="col-sm-4 col-md-4">
                        <div class="row">
                            ...
                            <div class="col-10">
                                <span style="font-size: 24;">Parceria desde 1990</span>
                            </div>
                        </div>
                        <br />
                        <div class="row">
                            ...
                            <div class="col-10">
                                <span style="font-size: 24;">Presente nos Estados: MA, PI, CE e RN</span>
                            </div>
                        </div>
                        <br />
                        <div class="row">
                            ...
                            <div class="col-10">
                                <span style="font-size: 24;">Atuando com 32 PDVS</span>
                            </div>
                        </div>
                        <br />
                        <div class="row">
