...
<div class="row">
    <div class="col-md-12">
        ...
        <div>
            <div  class="dragscroll" id="timeline-horizontal" style="cursor: pointer; display: inline-block; width:100%; overflow-y:hidden; overflow-x:hidden;">
                <ul class="timeline timeline-horizontal" >
                    ...
                    <li class="timeline-item">
                        ...
                        <div class="timeline-panel">
                            <div class="timeline-heading">
                                <h4 class="timeline-title">Magrella Decorações</h4>
                    ...
                    <!-- 03 -->
                    <li class="timeline-item">
                        <div class="timeline-badge success">1990</div>
                        <div class="timeline-panel">
                            <div class="timeline-heading">
                    ...
                    <!-- 09 -->
                    <li class="timeline-item">
                        <div class="timeline-badge warning">2006</div>
                        <div class="timeline-panel">
                            <div class="timeline-heading">
                                <h4 class="timeline-title">
                                    Rádio MaisFM (FAJI)
                    ...
                    <!-- 17 -->
                    <li class="timeline-item">
                        <div class="timeline-badge danger ">2019</div>
                        <div class="timeline-panel outer">
                            <div class="timeline-heading">
                                <h4 class="timeline-title">
                                    AREZZO Iguatu
                    ...
                    <!-- 21 -->
                    <li class="timeline-item">
                        <div class="timeline-badge success">2020</div>
                        <div class="timeline-panel">
                            <div class="timeline-heading">
                                <h4 class="timeline-title">
...
<div class="row">
    <div style="width: 75px; margin: 0 auto;">
        <button class="btn btn-primary" id="prevTimeline"><</button>
        <button class="btn btn-primary" id="nextTimeline">></button>
    </div>
</div>